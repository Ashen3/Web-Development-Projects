...
function makePassword(){
    ...
    const newPassword  =createRandomPassword(length, includeUppercase, 
        includeLowercase, includeNumbers, includeSymbols)
    
    passwordInput.value = newPassword
    udpateStrengthMeter(newPassword)
}

function udpateStrengthMeter(password){
    ...
    strengthScore += Math.min(passwordLenght * 2, 40)
